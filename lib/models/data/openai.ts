...
const openaiModels: ModelConfig[] = [
  ...
  },
  {
    ...
    baseProviderId: "openai",
    description:
      "Fast, cost-efficient GPT-5.4 tier for well-defined tasks.",
  ...
  {
    // Routable but not promoted: the pricing page lists it, the models page
    // does not headline it (plan §2D).
    id: "gpt-5.4-nano",
    name: "GPT-5.4 Nano",
    provider: "OpenAI",
    providerId: "openai",
