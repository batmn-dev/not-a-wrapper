...
export const STANDARD_SUITE: BrowserScenarioConfig[] = [
  ...
  {
    ...base,
    id: "code-stress-30-fixed",
    scenario: "code-stress",
    chunksPerSecond: 30,
    shape: "fixed",
  },
  {
    ...base,
    id: "mixed-markdown-100-bursty",
    scenario: "mixed-markdown",
    chunksPerSecond: 100,
    shape: "bursty",
  },
  ...
  {
    ...base,
    id: "mixed-markdown-30-fixed-mobile",
    scenario: "mixed-markdown",
    chunksPerSecond: 30,
    shape: "fixed",
    viewport: "mobile",
  ...
  {
    ...base,
    id: "mixed-markdown-30-fixed-cpu4",
    scenario: "mixed-markdown",
    chunksPerSecond: 30,
    shape: "fixed",
    cpuThrottle: 4,
  ...
  {
    ...base,
    id: "stop-during-text-10-fixed",
    scenario: "stop-during-text",
    chunksPerSecond: 10,
    shape: "fixed",
    action: "stop",
...
/** Six user journeys, with one constrained-device repeat rather than a Cartesian matrix. */
export const RESPONSIVENESS_SUITE: BrowserScenarioConfig[] = [
  {
    ...base,
    id: "new-chat-cold",
