...
| Assistant memory: user-facing memory management                               | `LibreChat`                | [LibreChat](https://github.com/danny-avila/LibreChat)         | User-visible memory settings, editing, and management UX                                                                                         |
| Assistant memory in TypeScript or the Vercel AI SDK                           | `supermemory`              | [Supermemory](https://github.com/supermemoryai/supermemory)   | Memory profiles, scoping, and retrieval in a TypeScript/AI SDK stack                                                                             |
| Assistant memory: extraction, reconciliation, or lifecycle                    | `mem0`                     | [Mem0](https://github.com/mem0ai/mem0)                        | Memory extraction, reconciliation of new vs. stored facts, and memory lifecycle                                                                  |
| Assistant memory: temporal facts, contradictions, or provenance               | `graphiti`                 | [Graphiti](https://github.com/getzep/graphiti)                | Temporally-aware facts, contradiction handling, and provenance tracking                                                                          |
| Assistant memory: persistent agent identity or editable memory blocks         | `letta`                    | [Letta](https://github.com/letta-ai/letta)                    | Persistent agent identity and agent-editable memory blocks                                                                                       |
