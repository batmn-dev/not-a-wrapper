...
const ITEMS = [
  {
    id: 1,
    label: "User",
    title: <Icon icon={RiUserLine} slotSize={20} />,
    content: (
  ...
  },
  {
    id: 2,
    label: "Messages",
    title: <Icon icon={RiChat3Line} slotSize={20} />,
    content: (
      <div className="flex flex-col space-y-4">
  ...
  },
  {
    id: 3,
    label: "Documents",
    title: <Icon icon={RiFolderLine} slotSize={20} />,
    content: (
      <div className="flex flex-col space-y-4">
  ...
  },
  {
    id: 4,
    label: "Wallet",
    title: <Icon icon={RiWalletLine} slotSize={20} />,
    content: (
      <div className="flex flex-col space-y-4">
        <div className="flex flex-col text-zinc-700">
          ...
          <div className="flex space-x-2 p-2" ref={menuRef}>
            {ITEMS.map((item) => (
              <button
                ...
                className={cn(
                  "relative flex h-9 w-9 shrink-0 scale-100 appearance-none items-center justify-center rounded-lg text-zinc-500 transition-colors select-none hover:bg-zinc-100 hover:text-zinc-800 focus-visible:ring-2 active:scale-[0.98]",
