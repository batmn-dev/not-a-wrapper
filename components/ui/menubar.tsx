  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        "focus:text-foreground relative flex cursor-pointer items-center gap-2 pr-2 pl-8 text-sm outline-hidden select-none data-disabled:cursor-not-allowed data-disabled:opacity-50 data-inset:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      checked={checked}
      {...props}
...
function MenubarRadioItem({
  ...
  return (
    <MenuPrimitive.RadioItem
      ...
      className={cn(
        floatingMenuItemClassName,
        "focus:text-foreground relative flex cursor-pointer items-center gap-2 pr-2 pl-8 text-sm outline-hidden select-none data-disabled:cursor-not-allowed data-disabled:opacity-50 data-inset:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-5",
        className
      )}
      {...props}
    >
