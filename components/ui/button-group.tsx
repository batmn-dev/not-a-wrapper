...
function ButtonGroupText({
  ...
  return useRender({
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          "bg-muted flex items-center gap-2 rounded-md px-2.5 text-sm font-medium shadow-border-xs [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4",
          className
        ),
      },
      props
...
function ButtonGroupSeparator({
  ...
  return (
    <Separator
      ...
      className={cn(
        "bg-border-default relative self-stretch data-horizontal:mx-px data-horizontal:w-auto data-vertical:my-px data-vertical:h-auto",
        className
      )}
      {...props}
    />
