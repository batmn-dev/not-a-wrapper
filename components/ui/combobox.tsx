...
function ComboboxClear({ className, ...props }: ComboboxPrimitive.Clear.Props) {
  return (
    <ComboboxPrimitive.Clear
      ...
      {...props}
    >
      <Icon icon={RiCloseLine} className="pointer-events-none" />
    </ComboboxPrimitive.Clear>
  )
}
...
function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        floatingMenuItemClassName,
        "menu-item-hoverable data-highlighted:text-foreground relative flex cursor-pointer items-center gap-2 pr-8 text-sm outline-hidden select-none data-disabled:cursor-not-allowed data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
...
function ComboboxChipsInput({
  ...
  return (
    <ComboboxPrimitive.Input
      ...
      className={cn("min-w-16 flex-1 outline-none", className, "text-base")}
      {...props}
    />
  )
}
